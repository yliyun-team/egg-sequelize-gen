...
describe(helpers.getTestDialectTeaser("sequelize-gen"), function() {
  after(function(done) {
  ...
  var setupModels = function(self, callback) {
    ...
    var execString = path.join(__dirname, "..", "bin", "sequelize-gen") + " -o \"" + testConfig.directory + "\" -d " + config.database + " -h " + config.host;
